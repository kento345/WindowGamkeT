...
bool PiplineStateObject::create(const Shader& shader, const RootSignature& rootSignature)noexcept
{
...
ID3D12PipelineState* PiplineStateObject::get()const noexcept
{
	if (!piplineState_) {
