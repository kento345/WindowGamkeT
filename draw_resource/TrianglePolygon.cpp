...
bool TrianglePolygon::createVertexBuffer() noexcept {
	...
	heapPropery.Type = D3D12_HEAP_TYPE_UPLOAD;
	heapPropery.CPUPageProperty = D3D12_CPU_PAGE_PROPERTY_UNKNOWN;
	heapPropery.MemoryPoolPreference = D3D12_MEMORY_POOL_UNKNOWN;
	heapPropery.CreationNodeMask = 1;
	heapPropery.VisibleNodeMask = 1;
...
bool TrianglePolygon::createIndexBuffer() noexcept {
